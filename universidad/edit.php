...
<html>
    ...
    $db = new Database;
    $newUniversidad = new Universidad($db);
    $newUniversidad->setID($id_u);
    $universidad = $newUniversidad->get();
    $newUniversidad->checkUser($universidad);
  
    ?>
    <div class="container">
        <div class="col-lg-12">
            <h2 class="text-center text-primary">Editar Universidad <?php echo $universidad->name_u ?></h2>
            <form action="update.php" method="POST">
                      
                    <div class="form-group">
                    <label for="username">Nombre de Universidad</label>
                    <input type="text" name="name_u" value="<?php echo $universidad->name_u ?>" class="form-control" id="username" placeholder="NOMBRE CIUDAD">
                    </div>
                    ...
                    <input type="hidden" name="id_u" value="<?php echo $universidad->id_u ?>" />

                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php
                                        ...
                                        $tiposproyecto = $tipoproyecto->get();
                                        ?>
                                       
                                                <div class="col-lg-2 pull-right" style="margin-bottom: 10px">
                                                    <a class="btn btn-info" href="add.php">Agregar Tipo</a>
                                                </div>
                                                <?php
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td><?php echo $tipoproyecto->id_tipo ?></td>
                                                            <td><?php echo $tipoproyecto->descrip_tipo ?></td>
                                                            <td>
                                                                <a class="btn btn-info" href="edit.php?user=<?php echo $tipoproyecto->id_tipo ?>">Editar</a> 
                                                                <a class="btn btn-info" href="delete.php?user=<?php echo $tipoproyecto->id_tipo ?>">Eliminar</a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }

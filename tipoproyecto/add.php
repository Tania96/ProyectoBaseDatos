...
<html>
    ...
    <div class="container">
        <div class="col-lg-12">
            <h2 class="text-center text-primary">Agregar Tipo de Proyecto</h2>
            <form action="save.php" method="POST">
            <div class="form-group">
                    <label for="password">ID Tipo</label>
                    <input type="number" name="id_tipo" value="" class="form-control" id="password" placeholder="ID">
                </div>   
            
            <div class="form-group">
                    <label for="username">Descripcion de Tipo</label>
                    <input type="text" name="descrip_tipo" value="" class="form-control" id="username" placeholder="NameTipo">
                </div>

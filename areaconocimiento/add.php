...
<html>
    ...
    <div class="container">
        <div class="col-lg-12">
            <h2 class="text-center text-primary">Agregar Area de Conocimiento</h2>
            <form action="save.php" method="POST">
            <div class="form-group">
                    <label for="password">ID Area</label>
                    <input type="number" name="id_area" value="" class="form-control" id="password" placeholder="ID">
                </div>   
            
            <div class="form-group">
                    <label for="username">Descripcion de Area</label>
                    <input type="text" name="descrip_area" value="" class="form-control" id="username" placeholder="NameArea">
                </div>

...
<html>
    ...
    $db = new Database;
    $newAreaConocimiento = new AreaConocimiento($db);
    $newAreaConocimiento->setId($id_area);
    $areaconocimiento = $newAreaConocimiento->get();
    $newAreaConocimiento->checkUser($areaconocimiento);
    ?>
    <div class="container">
        <div class="col-lg-12">
            <h2 class="text-center text-primary">Editar Area <?php echo $areaconocimiento->descrip_area ?></h2>
            <form action="update.php" method="POST">
                         
            
            <div class="form-group">
                    <label for="username">Descripcion Area</label>
                    <input type="text" name="descrip_area" value="<?php echo $areaconocimiento->descrip_area ?>" class="form-control" id="username" placeholder="Username">
                </div>
                <input type="hidden" name="id_area" value="<?php echo $areaconocimiento->id_area ?>" />

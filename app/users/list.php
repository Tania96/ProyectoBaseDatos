        ...
        <div class="container">
            <div class="col-lg-12">
                ...
                <div class="col-lg-1 pull-right" style="margin-bottom: 10px">
                    <a class="btn btn-info" href="../users/add.php">Add user</a>
                </div>
                <?php
                if( ! empty( $users ) )
                {
                ...
                <table class="table table-striped">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info" href="../users/edit.php?user=<?php echo $user->id ?>">Edit</a> 
                                <a class="btn btn-info" href="../users/delete.php?user=<?php echo $user->id ?>">Delete</a>
                            </td>
                        </tr>
                    <?php
                    }

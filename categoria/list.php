                        ...
                        <?php
                                        ...
                                        ?>
                                                ...
                                                <div class="col-lg-2 pull-right" style="margin-bottom: 10px">
                                                    <a class="btn btn-info" href="add.php">Agregar Categoria</a>
                                                </div>
                                                <?php
                                                if( ! empty( $categorias ) )
                                                {
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $categoria->descrip_cat ?></td>
                                                            <td>
                                                                <a class="btn btn-info" href="edit.php?user=<?php echo $categoria->id_cat ?>">Edit</a> 
                                                                <a class="btn btn-info" href="delete.php?user=<?php echo $categoria->id_cat ?>">Delete</a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }

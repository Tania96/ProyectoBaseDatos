        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    $sql = "select * from conferencia_centro";
                    ...
                    <table class="table table-striped" style="font-size:13.5px">
                        <tr>
                            ...
                            <th>N° Articulos Publicados</th>

                        </tr>
                        <?php while ($line = pg_fetch_array($resultado, null, PGSQL_ASSOC)) {
                            echo "<tr>";

                            echo "<td>" . $line['name_centro'] . "</td>";

                            echo "<td>" . $line['name_conf'] . "</td>";

                            echo "<td>" . $line['numero_articulos_publicados'] . "</td>";
                    ...
                    $sql2 = "SELECT *FROM CONFERENCIA_CENTRO CEC WHERE CEC.NUMERO_ARTICULOS_PUBLICADOS = ( 

        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    $sql = "select * from INVESTIGADOR_REVISTA";
                    ...
                    <table class="table table-striped" style="font-size:13.5px">
                        ...
                        <tr>
                            ...
                            <th>Contador de Revistas Publicadas</th>
                        ...
                        <?php while ($line = pg_fetch_array($resultado, null, PGSQL_ASSOC)) {
                            ...
                            echo "<td>" . $line['contador_presentaciones_revista'] . "</td>";
                    ...
                    $sql2 = "SELECT *FROM INVESTIGADOR_CONFERENCIA";
                        ...
                        <div class="col-lg-12">
                            ...
                            <table class="table table-striped" style="font-size:13.5px">
                                ...
                                <tr>
                                    ...
                                    <th>NOMBRE INVESTIGADOR</th>
                                    <th>Rut Investigador</th>
                                    <th>Contador de Conferencias Publicadas</th>
                                ...
                                <?php while ($line = pg_fetch_array($resultado2, null, PGSQL_ASSOC)) {
                                    ...
                                    echo "<td>" . $line['contador_presentaciones_conferencia'] . "</td>";
                    ...
                    $sql3 = "SELECT IC.NAME_INV,IC.RUT_INV,IC.CONTADOR_PRESENTACIONES_CONFERENCIA , INREV.CONTADOR_PRESENTACIONES_REVISTA

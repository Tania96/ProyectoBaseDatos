...
<html>
    ...
    $db = new Database;
    $newRegion = new Region($db);
    $newRegion->setId($id_reg);
    $region = $newRegion->get();
    $newRegion->checkUser($region);
    ?>
    <div class="container">
        <div class="col-lg-12">
            <h2 class="text-center text-primary">Edit region <?php echo $region->name_reg ?></h2>
            <form action="update.php" method="POST">
                         
            
            <div class="form-group">
                    <label for="username">Nombre de Region</label>
                    <input type="text" name="name_reg" value="<?php echo $region->name_reg ?>" class="form-control" id="username" placeholder="Username">
                </div>
                <input type="hidden" name="id" value="<?php echo $region->id_reg ?>" />

...
<html>
    <head>
        <meta charset="utf-8">
        <title>Listado de categorias de revista</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Categorias de Revista
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.html">Lista de categorias de revista</a>
                            </li>
                            <li class="active">
    ...
    $db = new Database;
    $newCategoriaRevista = new CategoriaRevista($db);
    $newCategoriaRevista->setId($id_cat_rev);
    $categoriarevista = $newCategoriaRevista->get();
    $newCategoriaRevista->checkUser($categoriarevista);
    ?>
    <div class="container">
        <div class="col-lg-12">
            <h2 class="text-center text-primary">Editar Categoria Revista <?php echo $categoriarevista->descrip_cat_rev ?></h2>
            <form action="update.php" method="POST">
                         
            
            <div class="form-group">
                    <label for="username">Descripcion Categoria Revista</label>
                    <input type="text" name="descrip_cat_rev" value="<?php echo $categoriarevista->descrip_cat_rev ?>" class="form-control" id="username" placeholder="Username">
                </div>
                <input type="hidden" name="id_cat_rev" value="<?php echo $categoriarevista->id_cat_rev ?>" />

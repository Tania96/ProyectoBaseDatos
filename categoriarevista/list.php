                        ...
                        <?php
                                        ...
                                        ?>
                                                ...
                                                <div class="col-lg-3 pull-right" style="margin-bottom: 10px">
                                                    <a class="btn btn-info" href="add.php">Agregar Categoria Revista</a>
                                                </div>
                                                <?php
                                                if( ! empty( $categoriarevista ) )
                                                {
                                                ?>
                                                <table class="table table-striped">
                                                    <tr>
                                                        <th>Id</th>
                                                        <th>Descripcion de Categoria de Revista</th>
                                                        <th>Actions</th>
                                                    </tr>
                                                    <?php foreach( $categoriasrevista as $categoriarevista )
                                                    {
                                                    ?>
                                                        <tr>
                                                            <td><?php echo $categoriarevista->id_cat_rev ?></td>
                                                            <td><?php echo $categoriarevista->descrip_cat_rev ?></td>
                                                            <td>
                                                                <a class="btn btn-info" href="edit.php?user=<?php echo $categoriarevista->id_cat_rev ?>">Editar</a> 
                                                                <a class="btn btn-info" href="delete.php?user=<?php echo $categoriarevista->id_cat_rev ?>">Eliminar</a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }

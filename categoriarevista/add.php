...
<html>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.html">Lista de categoris de revista</a>
                            </li>
                            <li class="active">
    ...
    <div class="container">
        <div class="col-lg-12">
            <h2 class="text-center text-primary">Agregar Categoria de Revista</h2>
            <form action="save.php" method="POST">
            <div class="form-group">
                    <label for="password">ID Categoria Revista</label>
                    <input type="number" name="id_cat_rev" value="" class="form-control" id="password" placeholder="ID">
                </div>   
            
            <div class="form-group">
                    <label for="username">Descripcion de Categoria de Revista</label>
                    <input type="text" name="descrip_cat_rev" value="" class="form-control" id="username" placeholder="NameCatRev">
                </div>

...
<html>
    ...
    $newRol->setId($id_rol);
    $rol = $newRol->get();
    $newRol->checkUser($rol);
    ?>
    <div class="container">
        <div class="col-lg-12">
            <h2 class="text-center text-primary">Editar Rol <?php echo $rol->descrip_rol ?></h2>
            <form action="update.php" method="POST">
                         
            
            <div class="form-group">
                    <label for="username">Descripcion de Rol</label>
                    <input type="text" name="descrip_rol" value="<?php echo $rol->descrip_rol ?>" class="form-control" id="username" placeholder="Username">
                </div>

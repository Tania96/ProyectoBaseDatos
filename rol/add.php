...
<html>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="list.php"><i class="fa fa-fw fa-wrench"></i> Roles</a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.html">Lista de roles</a>
                            </li>
                            <li class="active">
    ...
    <div class="container">
        <div class="col-lg-12">
            <h2 class="text-center text-primary">Agregar Rol</h2>
            <form action="save.php" method="POST">
            <div class="form-group">
                    <label for="password">ID de Rol</label>
                    <input type="number" name="id_rol" value="" class="form-control" id="password" placeholder="ID">
                </div>   
            
            <div class="form-group">
                    <label for="username">Descripcion de Rol</label>
                    <input type="text" name="descrip_rol" value="" class="form-control" id="username" placeholder="NameRol">
                </div>
